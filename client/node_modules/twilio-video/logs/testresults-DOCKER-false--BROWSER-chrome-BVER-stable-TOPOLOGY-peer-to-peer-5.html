...
<html>
  <head>
    <meta charset="utf-8"/>
    <title>twilio-video.js Integration Tests - testresults-DOCKER-false--BROWSER-chrome-BVER-stable-TOPOLOGY-peer-to-peer-5</title>
  ...
  <body class="compact">
    <h1>twilio-video.js Integration Tests</h1>
    <h2>testresults-DOCKER-false--BROWSER-chrome-BVER-stable-TOPOLOGY-peer-to-peer-5</h2>
    <table cellspacing="0" cellpadding="0" border="0">
      <tr class="overview">
        <td colspan="3" title="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36">Browser: Chrome 76.0.3809 (Linux 0.0.0)</td>
      </tr>
      <tr class="overview">
        <td colspan="3">Timestamp: 8/29/2019, 7:12:10 PM</td>
      </tr>
      <tr>
        <td colspan="3">
          24 tests / 
      ...
      <tr class="skip">
        <td>Skipped</td>
        <td>is raised whenever the dominant speaker in the Room changes</td>
        <td>Room &raquo; "dominantSpeakerChanged" event</td>
      </tr>
      <tr class="skip">
        <td>Skipped</td>
        <td>is raised whenever recording is started on the Room via the REST API</td>
        <td>Room &raquo; "recordingStarted" event</td>
      </tr>
      <tr class="skip">
        <td>Skipped</td>
        <td>is raised whenever recording is stopped on the Room via the REST API</td>
        <td>Room &raquo; "recordingStopped" event</td>
      </tr>
      <tr class="system-out">
        <td colspan="3"><strong>System output:</strong><br />Chrome 76.0.3809 (Linux 0.0.0) WARN: '2019-08-29', '19:12:13.285Z', '|', 'WARN', 'in', '[TwilioConnection #7: wss://global.vss.twilio.com/signaling]:', 'Closed: 1005 - '
</td>
      </tr>
    </table>
    <hr/>
