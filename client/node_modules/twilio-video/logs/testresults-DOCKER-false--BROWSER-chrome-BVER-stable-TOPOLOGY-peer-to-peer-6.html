...
<html>
  <head>
    <meta charset="utf-8"/>
    <title>twilio-video.js Integration Tests - testresults-DOCKER-false--BROWSER-chrome-BVER-stable-TOPOLOGY-peer-to-peer-6</title>
  ...
  <body class="compact">
    ...
    <h2>testresults-DOCKER-false--BROWSER-chrome-BVER-stable-TOPOLOGY-peer-to-peer-6</h2>
    <table cellspacing="0" cellpadding="0" border="0">
      ...
      <tr class="overview">
        <td colspan="3">Timestamp: 8/29/2019, 7:12:19 PM</td>
      </tr>
      <tr>
        <td colspan="3">
          4 tests / 
